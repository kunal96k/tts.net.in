...
// ===== GLOBAL IMAGE LIGHTBOX MODAL SYSTEM =====
function initGlobalImageModal() {
    if (!document.getElementById('globalImageModal')) {
        const modalHTML = `
        <div class="global-image-modal-backdrop" id="globalImageModal" role="dialog" aria-modal="true">
            <div class="global-image-modal">
                <button class="global-modal-close-btn" id="closeGlobalImageModal" aria-label="Close Lightbox">
                    <ion-icon name="close-outline"></ion-icon>
                </button>
                <div class="global-modal-image-container">
                    <img id="globalModalImg" src="" alt="Showcase Preview">
                </div>
                <div class="global-modal-body">
                    <h3 class="global-modal-title" id="globalModalTitle"></h3>
                    <p class="global-modal-desc" id="globalModalDesc"></p>
                </div>
            </div>
        </div>`;
    ...
    const backdrop = document.getElementById('globalImageModal');
    const modalImg = document.getElementById('globalModalImg');
    const modalTitle = document.getElementById('globalModalTitle');
    const modalDesc = document.getElementById('globalModalDesc');
    const closeBtn = document.getElementById('closeGlobalImageModal');

    function openModal(imgSrc, title, desc) {
        if (!imgSrc) return;
        modalImg.src = imgSrc;
        modalTitle.textContent = title || 'TechnoKraft Showcase';
    ...
    // Attach click listener to showcase cards & certification cards
    document.querySelectorAll('.showcase-card, .cert-card').forEach(card => {
        ...
        card.addEventListener('click', (e) => {
            ...
            const title = card.querySelector('h4, h3, .card-title')?.textContent || img.alt || 'TechnoKraft Showcase';
